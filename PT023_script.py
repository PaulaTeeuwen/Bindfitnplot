...
m_Hstock1 = 1.41 * 10**(-3) # g  The weighed mass of the Host
V_solv_Hstock = 20.00  # mL The volume of the relevant volumetric flask
m_solv_Hstock1 = 22.77309  # g The weighed mass of the solvent + Host

# Host-stock 2
m_Hstock2 = 1.49 * 10**(-3) # g The weighed mass of the Host (Held at least 1h under vacuum)
m_solv_Hstock2 = 22.78339   # g The weighed mass of the solvent + Host

# Host-stock 3
m_Hstock3 = 1.42 * 10**(-3) # g The weighed mass of the Host
m_solv_Hstock3 = 22.73437   # g The weighed mass of the solvent + Host

# Guest-stock 1
M_Guest = 728.66 # g/mol   (S,S)-V2
m_Gstock1 = 1.46 * 10**(-3) # g The weighed mass of the Guest
V_solv_Gstock = 10.00 # mL +- 0.025 mL ; The volume of the relevant volumetric flask
m_solv_Gstock1 = 11.37128   # g The weighed mass of the solvent + Guest

# Guest-stock 2
m_Gstock2 = 1.46 * 10**(-3) # g The weighed mass of the Guest
m_solv_Gstock2 = 11.35508  # g The weighed mass of the solvent + Guest

# Guest-stock 3
m_Gstock3 = 1.48 * 10**(-3) # g The weighed mass of the Guest # Verander deze waarde, veranderd ook Ka van 1 en 2 ?????????/
m_solv_Gstock3 = 11.3669  # g The weighed mass of the solvent + Guest

# Host-measurement
V_solv_Hmeasure = 10.00 # mL +- 0.025 mL ;
m_Hstock_diluted1 = 0.33619 # g The weighed Host-stock before dilution, with known density calculated earlier
m_Hstock_diluted2 = 0.33823 # g
m_Hstock_diluted3 = 0.3415 # g
...
m_Gstock_diluted1 = 4.41387 # g The weighed Guest-stock before dilution, with known density calculated earlier
m_Gstock_diluted2 = 4.46793 # g
m_Gstock_diluted3 = 4.50188# g
m_Hstock_diluted_forGmeasurement1 = 0.17684 # g The weighed Host-stock before dilution that is added to the flask
m_Hstock_diluted_forGmeasurement2 = 0.17705 # g
m_Hstock_diluted_forGmeasurement3 = 0.18815 # g
# etc...

# Measurement
n = 3 #triplo
m1 = 39  #amount of measurements
m2 = 39
m3 = 39
...
for i in np.arange(1,n+1):
    ...
    middlevalues = np.full(19,50)
    endvalues = np.array([100, 200, 200, 300])

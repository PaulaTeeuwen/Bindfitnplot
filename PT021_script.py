...
m_solv_Gstock1 = 11.3557   # g The weighed mass of the solvent + Guest

# Guest-stock 2
m_Gstock2 = 1.45 * 10**(-3) # g The weighed mass of the Guest
m_solv_Gstock2 = 11.36199  # g The weighed mass of the solvent + Guest

# Guest-stock 3
m_Gstock3 = 1.58 * 10**(-3) # g The weighed mass of the Guest # Changing this to 1.45 influences both Ka of 1 and 2 ?????????
m_solv_Gstock3 = 11.34936  # g The weighed mass of the solvent + Guest
...
m_Gstock_diluted1 = 4.47489 # g The weighed Guest-stock before dilution, with known density calculated earlier
m_Gstock_diluted2 = 4.43397 # g
m_Gstock_diluted3 = 4.46268 # g
m_Hstock_diluted_forGmeasurement1 = 0.1733 # g The weighed Host-stock before dilution that is added to the flask
m_Hstock_diluted_forGmeasurement2 = 0.15759 # g
m_Hstock_diluted_forGmeasurement3 = 0.17312 # g
# etc...

# Measurement
n = 3 #triplo
m1 = 37 #39 #amount of measurements
m2 = 38
m3 = 38
...
for i in np.arange(1,n+1):
    ...
    if i == 1:
        #endvalues = np.array([400, 400, 0, 0])
        endvalues = np.array([400, 400])
    if i == 2:
        #endvalues = np.array([100,200,500,0,0])
        endvalues = np.array([100,200,500])
    if i == 3:
        endvalues = np.array([100,200,500])
